...
// Example: your converted Kruti Dev text
...
const unicodeText = "आज हमारा स्वस्थ शिक्षा का समय है";
const legacy_text_var = Convert_to_Kritidev_010(unicodeText);
  ...
  sections: [
    {
      ...
      children: [
        new Paragraph({
          children: [
            new TextRun({
              text: legacy_text_var,
              font: "Kruti Dev 055", // 👈 tells Word to use this font
...
Packer.toBuffer(doc).then((buffer) => {
  ...
  console.log("✅ Word file created: output.docx");
});
